    ...
    <>
      <div className="progress-bar-container" id='progressBarID'>
        ...
        <div className="progress-bar-star-container">
          <Image
            src={
              num >= 1 ? Assets?.intro?.sprites[4] : Assets?.intro?.sprites[3]
            }
            alt="txt"
          ...
          <Image
            src={
              num >= 2 ? Assets?.intro?.sprites[4] : Assets?.intro?.sprites[3]
            }
            alt="txt"
            id="progress-bar-stars"
          ...
          <Image
            src={
              num >= 3 ? Assets?.intro?.sprites[4] : Assets?.intro?.sprites[3]
            }
            alt="txt"
            id="progress-bar-stars"
          ...
          <Image
            src={
              num >= 4 ? Assets?.intro?.sprites[4] : Assets?.intro?.sprites[3]
            }
            alt="txt"
            id="progress-bar-stars"
          ...
          <Image
            src={
              num >= 5 ? Assets?.intro?.sprites[4] : Assets?.intro?.sprites[3]
            }
            alt="txt"
            id="progress-bar-stars"
          ...
          <Image
            src={
              num >= 6 ? Assets?.intro?.sprites[4] : Assets?.intro?.sprites[3]
            }
            alt="txt"
            id="progress-bar-stars"
          ...
          <Image
            src={
              num >= 7 ? Assets?.intro?.sprites[4] : Assets?.intro?.sprites[3]
            }
            alt="txt"
            id="progress-bar-stars"
